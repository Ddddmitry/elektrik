$(document).ready(function () {
    ...
    let $formEventUpdate = $('[data-back-form-event-update]');
    if ($formEventUpdate.length) {
        $formEventUpdate.on('submit', (e) => {
            e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        if (data.success) {
                            ...
                            window.location.href = "/backoffice/distributors/events/";
                            setTimeout(function () {
