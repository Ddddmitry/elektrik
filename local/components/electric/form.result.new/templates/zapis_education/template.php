...
<?
if (strlen($_POST['web_form_submit']) && $_POST['web_form_submit'] == "Y" && $_POST['web_form_type'] == "zapis_education") {
...
?>
<?$arResult["FORM_HEADER"] = str_replace('ZAPIS_EDUCATION"','ZAPIS_EDUCATION" class="education__form" ',$arResult["FORM_HEADER"]);?>


<div class="education__bottom-form">
    ...
    ?>
        ...
        <div class="event__form-items">
            <div class="event__form-item event__form-item--sm">
                <input type="text" name="form_text_14" id="" placeholder="ФИО" class="field-input field-input--white">
            </div>
            <div class="event__form-item event__form-item--sm">
                <input type="text" name="form_text_15" id="" placeholder="Номер телефона" data-phone
                       class="field-input field-input--white">
            </div>
            <div class="event__form-item event__form-item--sm">
                <input type="hidden" name="web_form_submit" value="Y" />
                <input type="hidden" name="web_form_type" value="zapis_education" />
...
<div class="education__bottom-success">
    <div class="education__bottom-middle">
        <img src="<?=SITE_TEMPLATE_PATH?>/images/logo-check-form.png" class="education__bottom-logo" alt="">
        <div class="education__bottom-description">
            ...
            <a href="#" class="main__text link js-education-more">Отправить еще одну заявку</a>
        </div>
    </div>
</div>
...
<script>
	$(document).on('submit', 'form.education__form', function(e){
	    e.preventDefault();
	    var $form = $(this);
	    $.post($form.attr('action'), $form.serialize(), function(data){
	        ...
	        if (data.type == 'error') {
                ...
                $('.education__bottom').addClass('is-success');
	        }
	    }, 'json');
	    return false;
	});
